...
{
    public sealed class GetAllTemplateJawabanWithPagingQuery : IQuery<PagedList<TemplateJawabanResponse>>, ISearchable
    {
        ...
        public GetAllTemplateJawabanWithPagingQuery(
